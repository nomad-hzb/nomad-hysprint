...
def get_jv_data_iris_json(filedata):
    ...
    for m in data['data']:
        ...
        jv_dict['Efficiency'].append(curve_parameters['Eff_1000 [%]'])
        jv_dict['J_MPP'].append(curve_parameters['J_mpp [mA/cm2]'])
        jv_dict['U_MPP'].append(curve_parameters['V_mpp [V]'])
        jv_dict['R_ser'].append(curve_parameters['Rs [\u2126cm2]'])
        jv_dict['R_par'].append(curve_parameters['Rp [\u2126cm2]'])
        jv_dict['jv_curve'].append(
            {
