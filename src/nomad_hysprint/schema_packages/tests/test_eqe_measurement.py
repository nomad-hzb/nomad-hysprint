...
def test_eqe_parser_valid(mock_eqe_file, mocker):
    ...
    mocker.patch("nomad_hysprint.schema_packages.file_parser.eqe_parser.read_file", return_value={
        "photon_energy": np.array([1.2, 1.5, 1.8]),
        "intensity": np.array([0.8, 0.85, 0.9])
    })
