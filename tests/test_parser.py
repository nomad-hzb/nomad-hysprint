...
def test_hy_batch_parser_new_cols(monkeypatch):  
    ...
    for m in measurement_archives:
        ...
        if m.data.positon_in_experimental_plan == 1:
            ...
            assert m.data.solution[0].solution_details.solvent[0].chemical_volume == 10 * ureg('uL')
            ...
            assert m.data.solution[0].solution_details.solvent[1].chemical_volume == 20 * ureg('uL')
            ...
            for i in range(5):
                ...
                assert m.data.solution[0].solution_details.solute[i].concentration_molar == 1.42 * ureg('mM')
